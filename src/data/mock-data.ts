...
export const spotOrders: SpotOrder[] = [
  ...
  },
  {
    ...
    source: "kakao",
    shipper: "충북정밀가공",
    pickup: { sido: "충북", sigungu: "청주시", dong: "흥덕구 옥산면", date: "D+0", dateISO: "2026-08-13", time: "17:40", manual: false, forklift: true },
    dropoff: { sido: "경기", sigungu: "화성시", dong: "향남읍", date: "D+0", dateISO: "2026-08-13", time: "19:50", manual: false, forklift: true },
    vehicle: { ton: 5, body: "윙바디" },
    loadOption: "독차",
    distance: { toPickupKm: 4.8, haulKm: 98 },
    durationMin: 130,
    fare: { base: 185000, extraManual: 0, total: 185000, settle: "인수증" },
    remarksRaw: "전자부품 파렛트 10개 / 당일 20시 전 하차 / 지게차 작업",
    conditions: [
      { type: "적재형태", value: "파렛트 10개", evidence: "파렛트 10개", status: "명시" },
      { type: "시간제약", value: "당일 20시 전 하차", evidence: "당일 20시 전 하차", status: "명시" },
      { type: "상하차방식", value: "지게차 상하차", evidence: "지게차 작업", status: "명시" },
    ],
    vehicleFit: { ok: true, reason: "" },
    postedAt: "2026-08-13T13:15:20",
  },
  {
    id: "SO-0813-12",
    source: "kakao",
    shipper: "청주로지스틱스",
    pickup: { sido: "충북", sigungu: "청주시", dong: "청원구 오창읍", date: "D+0", dateISO: "2026-08-13", time: "18:20", manual: false, forklift: true },
    dropoff: { sido: "경기", sigungu: "평택시", dong: "포승읍", date: "D+0", dateISO: "2026-08-13", time: "20:10", manual: false, forklift: true },
    vehicle: { ton: 5, body: "윙바디" },
    loadOption: "독차",
    distance: { toPickupKm: 8.5, haulKm: 82 },
    durationMin: 110,
    fare: { base: 160000, extraManual: 0, total: 160000, settle: "인수증" },
    remarksRaw: "자동차 부품 / 지게차 상하차 / 18시 30분 상차",
    conditions: [
      { type: "취급요건", value: "자동차 부품", evidence: "자동차 부품", status: "명시" },
      { type: "상하차방식", value: "지게차 상하차", evidence: "지게차 상하차", status: "명시" },
    ],
    vehicleFit: { ok: true, reason: "" },
    postedAt: "2026-08-13T13:40:10",
  },
